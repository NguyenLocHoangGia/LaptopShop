                        ...
                        <div class="col-12 mx-auto">
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Name: ${viewProduct.email}</li>
                                    <li class="list-group-item">Price: ${viewProduct.fullName}</li>
                                    <li class="list-group-item">Detail Description: ${viewProduct.address}</li>
                                    <li class="list-group-item">Short Description:${viewProduct.phone}</li>
                                    <li class="list-group-item">Target:${viewProduct.phone}</li>
                                    <li class="list-group-item">Factory:${viewProduct.phone}</li>
                                </ul>
                            </div>
