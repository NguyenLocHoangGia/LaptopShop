                                ...
                                <tbody>
                                    <c:forEach var="order" items="${orders}">
                                        <tr>
                                            ...
                                            <td>${order.status}</td>
                                            <td>
                                                <a href="/admin/order/details/${order.id}" class="btn btn-primary">View</a>
                                                <a href="/admin/user/update/${order.id}" class="btn btn-warning">Update</a>
                                                <a href="/admin/user/delete/${order.id}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
