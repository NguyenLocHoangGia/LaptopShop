                        ...
                        <div class="col-12 mx-auto">
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <!-- <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Price: ${viewProduct.price}</li>
                                    ...
                                    <li class="list-group-item">Image:
                                        <img src="/images/product/${viewProduct.image}" >
                                    </li>
                                    
                                </ul> -->
                                <div class="card" style="width: 60%">
                                                <img class="card-img-top" src="/images/product/${viewProduct.image}"
                                                    alt="Card image cap">
