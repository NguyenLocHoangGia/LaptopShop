                                ...
                                <tbody>
                                    <c:forEach var="products" items="${products}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/product/${products.id}" class="btn btn-primary">View</a>
                                                <a href="/admin/product/update/${products.id}" class="btn btn-warning">Update</a>
                                                <a href="/admin/product/delete/${products.id}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
