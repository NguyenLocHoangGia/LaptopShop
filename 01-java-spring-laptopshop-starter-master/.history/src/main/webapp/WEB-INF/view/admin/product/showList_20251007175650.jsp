                                ...
                                <tbody>
                                    <c:forEach var="products" items="${products}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/user/${products.id}" class="btn btn-primary">View</a>
                                                <a href="/admin/user/update/${products.id}" class="btn btn-warning">Update</a>
                                                <a href="/admin/user/delete/${products.id}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
