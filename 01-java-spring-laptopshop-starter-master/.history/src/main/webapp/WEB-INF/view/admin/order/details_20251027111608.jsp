                        ...
                        <div class="col-12 mx-auto">
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Tên người nhận: ${order.receiverName}</li>
                                    <li class="list-group-item">Id: ${order.receiverAddress}</li>
                                    <li class="list-group-item">Id: ${order.receiverPhone}</li>
                                    <li class="list-group-item">Id: ${order.totalPrice}</li>
                                    <li class="list-group-item">Id: ${order.status}</li>
                                </ul>
                            </div>
