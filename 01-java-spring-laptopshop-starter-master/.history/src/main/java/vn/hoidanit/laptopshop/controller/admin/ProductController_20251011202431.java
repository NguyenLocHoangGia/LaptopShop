...
public class ProductController {
    ...
    public String getUpdatePage(Model model, @PathVariable long id) {
        ...
        return "/admin/update/productPage";
    }
    ...
    public String postUpdatePage(Model model, @ModelAttribute("updateProduct") Product product) {
        ...
        if (updateProduct != null) {
            ...
            updateProduct.setDetailDesc(updateProduct.getDetailDesc());
            updateProduct.setShortDesc(updateProduct.getShortDesc());
            updateProduct.setFactory(updateProduct.getFactory());
            updateProduct.setTarget(updateProduct.getTarget());
            updateProduct.setSold(updateProduct.getSold());
